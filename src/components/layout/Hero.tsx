  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto">
        ...
        {/* Badge */}
        <div className="mb-6 inline-flex items-center gap-2 px-5 py-2 rounded-full text-sm font-bold"
        ...
        <p className="text-base md:text-lg mb-10 font-semibold"
          ...
          Donas artesanales · Medellín · A domicilio
        </p>
        ...
        >
          ...
          <span className="relative z-10">Pedir ahora por WhatsApp</span>
        </a>

        <p className="mt-5 text-xs" style={{ color: "rgba(255,255,255,0.3)" }}>
          ⏰ Solo por WhatsApp · Entrega en Medellín y alrededores
        </p>
      </div>
