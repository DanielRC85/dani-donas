      ...
      >
        ...
        <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
          ...
          <p className="text-base md:text-lg leading-relaxed mb-3 max-w-md mx-auto lg:mx-0"
            ...
            Rellena con delicioso arequipe. Masa suave, esponjosa.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4">
            <a
              ...
              // RECTIFICACIÓN: Añadimos 'justify-center' y 'w-full sm:w-fit' para centrado total
              className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 w-full sm:w-fit rounded-2xl font-black text-base text-white overflow-hidden transition-all duration-300 hover:scale-105"
              style={{
                background: `linear-gradient(135deg, ${accentColor} 0%, #c026d3 100%)`,
                boxShadow: `0 0 24px ${accentColor}50`,
                minWidth: "180px" // Asegura un tamaño base consistente
              }}
            >
              ...
              {/* Icono centrado por el flex gap */}
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="relative z-10 flex-shrink-0" aria-hidden="true">
              ...
              {/* Texto centrado */}
              <span className="relative z-10 whitespace-nowrap">Pedir ahora</span>
            </a>
          </div>
        </div>
