...
// Usamos SVG para las estrellas, es mucho más nítido y profesional que el emoji ⭐
const StarIcon = () => (
...
const reviews = [
  { 
    ...
    name: "Mariana Gómez", 
    location: "Envigado",
    text: "Las mejores donas que he probado. El relleno de arequipe es de otro mundo y la masa es súper esponjosa. ¡Recomendadísimas!", 
  ...
  { 
    ...
    location: "Medellín",
    text: "Súper puntuales con la entrega en la estación Poblado. Llegaron intactas y frescas. La Dona Boston es un 10/10.", 
  ...
  { 
    ...
    name: "Valentina M.", 
    location: "Itagüí",
    text: "Pedí la caja x4 para un regalo y quedaron encantados. El empaque es hermoso y todo se siente hecho con mucha dedicación.", 
...
export const SocialProof = () => {
  return (
    <section className="py-24 md:py-32 relative overflow-hidden flex justify-center w-full">
      {/* Resplandor de fondo sutil para dar profundidad */}
      ...
      <div className="max-w-6xl w-full px-5 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white mb-6 leading-tight">
            Más de 50 cajas entregadas <br className="hidden md:block" /> esta semana
          </h2>
          <div className="flex items-center justify-center gap-2">
            <div className="flex gap-1">
              {[...Array(5)].map((_, i) => <StarIcon key={i} />)}
            </div>
            <p className="text-sm text-gray-400 font-medium ml-2">Calificación de 5 estrellas</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {reviews.map((item) => (
            ...
            >
              {/* Estrellas individuales del review */}
              ...
              {/* Footer del card: Avatar + Info */}
              <div className="flex items-center gap-4 mt-auto pt-6 border-t border-white/5">
                {/* Avatar Premium con Initials */}
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-0.5">
                    Cliente Verificado · {item.location}
                  </p>
                </div>
              </div>
            </div>
